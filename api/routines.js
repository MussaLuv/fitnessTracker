...
const { destroyRoutine, updateRoutine, createRoutine, getAllPublicRoutines } = require("../db/routines");
...
routinesRouter.post("/:routineId/activities", async (req, res, next) => {
  ...
  try {
    const reRoutine = await addActivityToRoutine({ routineId, activityId, count, duration })
    if(!reRoutine) {
